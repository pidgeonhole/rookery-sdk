...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PidgeonholeMvpApi.TestCaseInput();
  });
  ...
  describe('TestCaseInput', function() {
    it('should create an instance of TestCaseInput', function() {
      // uncomment below and update the code to test TestCaseInput
      //var instane = new PidgeonholeMvpApi.TestCaseInput();
      //expect(instance).to.be.a(PidgeonholeMvpApi.TestCaseInput);
    });

    it('should have the property problemId (base name: "problem_id")', function() {
